...
class ROS2Env(gym.Env):
    ...
    def get_reward(self, state):
        ...
        if check_win(*state[LIDAR_SEGMENT:LIDAR_SEGMENT+2], self.x_goal, self.y_goal, self.min_range):
            print(state[LIDAR_SEGMENT:LIDAR_SEGMENT+2])
            print(self.x_goal)
            print(self.y_goal)
            print("WON!")
            return 100
    ...
    def step(self, action):
        ...
        info = {
            'x': next_state[LIDAR_SEGMENT],
            'y': next_state[LIDAR_SEGMENT+1],
